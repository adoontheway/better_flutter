...
const Map<String, String> en_US = {
  ...
  'About.DarkMode.title': "Dark Mode",
  'About.Language.title': "语言设置",
  'Dropdow.Item0': 'FC Barcelona',
  'Dropdow.Item1': 'Real Madrid',
  'Dropdow.Item2': 'Villareal',
  'Dropdow.Item3': 'Manchester City',
  'GetFlutter.desc1':
  ...
  'Accordion.title1': 'GF Accordion',
  'Accordion.title2': 'GF Accordion with Icon',
  'Accordion.title3': 'GF Accordion with trailing text',
  'Accordion.title4': 'GF Accordion with contentChild',
  'Label.Skip': 'Skip',
  'Label.LearnMore': 'Learn More',
  'Title.Welcome': 'Welcome !',
  'Label.Close': 'Close',
  'Label.Animation.Remind': "Touch Image to Start Animation",
  'Label.zh-CN': '中文',
  'Label.en-US': 'English',
};
